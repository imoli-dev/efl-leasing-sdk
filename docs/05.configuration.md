...
The [`Config`](06.api/02.efl-client/01.overview.md#configuration-and-http-client) value object describes how the SDK connects to the EFL Leasing Online API:
...
- `environment` ([`Environment`](01.index.md#config-and-environment)) – one of `Environment::Sandbox` or `Environment::Production`.
...
The [`Environment`](01.index.md#config-and-environment) enum is used internally to distinguish between sandbox and production environments:
...
Once you have [`Config`](06.api/02.efl-client/01.overview.md#configuration-and-http-client) and an implementation of [`HttpClientInterface`](06.api/07.http.md#httpclientinterface), create the main client:
