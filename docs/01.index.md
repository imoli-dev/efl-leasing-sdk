...
- Read [Getting started](/sdk/getting-started) to see how to configure the SDK and make your first request.
- Check [Installation](/sdk/installation) for environment requirements and Composer installation.
- Use [Quickstart](/sdk/quickstart) to follow a full minimal integration example.
- Explore the [API section](/sdk/api/overview) for detailed information about clients, models and errors.
