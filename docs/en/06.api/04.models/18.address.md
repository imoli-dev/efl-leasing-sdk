...
- `type` – Descriptor object with `id`, `name`, `version`; the SDK maps `typeId` to a full Descriptor,
- `city`, `street`, `houseNumber` – maps to the respective properties,
- `postal` – Descriptor object; the SDK maps `postalCode` to a full Descriptor,
- `country` – Descriptor object; the SDK maps `countryCode` to a full Descriptor,
